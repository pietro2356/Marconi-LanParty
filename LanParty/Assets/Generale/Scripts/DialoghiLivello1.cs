...
public static class DialoghiLivello1
{
    public static string[] dialoghi = new string[] {
        ";",
        "Bambino;Come è iniziato?",
        "Protagonista;Era una conseguenza indiretta di alcuni problemi nati durante la seconda rivoluzione industriale…",
        ";",
        //#DOMANDA 1,2
        ...
        "Francesco;Ciao, sì sono io, ho iniziato questa mattina, certo che questo lavoro è molto duro però non è niente rispetto al lavoro in campagna sono fiducioso che quando mi adatterò andrà molto meglio.",
        ...
        "Operaio;Comunque Gianni mi ha detto di mandarti dal lui, si trova al terzo piano, porta con te una chiave inglese.",
        ...
        "Gianni;Non odiano il lavoro in sé per quanto duro sia, bensì le condizioni che esso impone.",
        "Francesco;Che condizioni?",
        "Gianni;Ma come non lo sai?",
        "Francesco;No, un mio amico mi ha detto che qui c’è molto lavoro, e io mi sono fiondato visto che le cose in campagna andavano male.",
        ...
        "Gianni;Concordo, in più hai sentito di Luca? Pare si sia rotto una mano lavorando, allora Anselmo l’ha licenziato!" ,
        ...
        "Ormai a causa dei rifiuti che questa industria ci smaltisce dentro non si può più usare nè per lavarsi né tanto meno per bere. E poi le strade! Sono piene di escrementi dei cavalli per il carbone.",
        ...
        "Francesco;Ma signore, veramente io lavoro qui da oltre due anni.",
        ...
        "Anselmo;Ah no? Fuori dai cancelli, ogni mattina, ci sono centinaia di persone in attesa di avere un lavoro pensi veramente che non troverò uno migliore di te?",
        ...
        "Bambino;E poi, perchè una cosa così dannosa come una conseguenza della rivoluzione industriale venne portata avanti per così tanto tempo?",
